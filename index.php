...
<div class="container">
	<div class="jumbotron jumbotron-fluid">
	  <div class="container">
	    <h1 class="display-3">PT.MITRA GARDA PERKASA</h1>
	    <p class="lead">PT.MITRA GARDA PERKASA adalah perusahaan jasa satuan keamanan.</p>
	  </div>
	</div>
		...
		<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
		 ...
		 <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img class="d-block w-100" src="images/mgp.png" alt="First slide">
		    </div>
	  ...
	  <div class="col-sm-4">
	    <div class="card">
	      <div class="card-body">
	        ...
	        <p class="card-text">MGP akan memberikan layanan konsistensi, dan aman untuk karyawan, pelanggan dan lingkungan</p>
	      </div>
	    </div>
	  </div>
	  ...
	  <div class="col-sm-4">
	    <div class="card">
	      <div class="card-body">
	        ...
	        <p class="card-text">Nama perusahaan : PT. MITRA GARDA PERKASA</p>
